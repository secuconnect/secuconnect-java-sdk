...
public class SecupayTransactionProductDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, currency, purpose, orderId, basket, accrual, paymentAction, customer, redirectUrl, contract, container, optData, subscription, experience);
  }

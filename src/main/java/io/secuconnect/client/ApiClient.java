...
import io.secuconnect.client.auth.Authentication;
import io.secuconnect.client.auth.OAuth;
import io.secuconnect.client.cache.CacheItem;
import io.secuconnect.client.cache.FileCache;
import io.secuconnect.client.printer.ImitationDevicePrinter;
...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    setUserAgent("secuconnect-java-sdk/1.8.0");
  ...
  /**
   * Configure whether to verify certificate and hostname when making https requests. Default to true. NOTE: Do NOT set to false in production code,
  ...
  /**
   * Parse the given date string into Date object. The default <code>dateFormat</code> supports these ISO 8601 date formats: 2015-08-16 2015-8-16
   *
  ...
  /**
   * Parse the given datetime string into Date object. When lenientDatetimeFormat is enabled, the following ISO 8601 datetime formats are supported:
   ...
   *  Note: The 3-digit milli-seconds is optional. Time zone is required and can be in one of these formats:
   *   Z (same with +0000)
  ...
  /**
   * The path of temporary folder used to store downloaded files from endpoints with file response. The default value is <code>null</code>, i.e. using
  ...
  /**
   * Select the Accept header's value from the given accepts array: if JSON exists in the given array, use it; otherwise use all of them (joining into
   * a string)
   *
  ...
  /**
   * Select the Content-Type header's value from the given array: if JSON exists in the given array, use it; otherwise use the first one of the
   * array.
   *
   ...
   * @throws ApiException If fail to deserialize response body, i.e. cannot read response body or the Content-Type of the response is not supported.
   */
  ...
  public <T> T deserialize(Response response, Type returnType) throws ApiException {
    ...
    if (isJsonMime(contentType)) {
      ...
      throw new ApiException("Content type \"" + contentType + "\" is not supported for type: " + returnType, response.code(),
   ...
   * @param call Call
   * @return ApiResponse object containing response status, headers and data, which is a Java object deserialized from response body and would be null
  ...
  public Call buildCall(String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams,
      Map<String, Object> formParams, String[] authNames, ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public Request buildRequest(String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams,
      Map<String, Object> formParams, String[] authNames, ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {

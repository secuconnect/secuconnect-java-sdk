...
import io.secuconnect.client.auth.HttpBasicAuth;
import io.secuconnect.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private MutableConfiguration<String, CacheItem> configuration;

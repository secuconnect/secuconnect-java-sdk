...
public class PaymentSecupayInvoicesApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call paymentSecupayInvoicesCancelByIdCall(String paymentInvoiceId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/Payment/Secupayinvoices/{paymentInvoiceId}/cancel"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call paymentSecupayInvoicesCancelByIdValidateBeforeCall(String paymentInvoiceId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'paymentInvoiceId' is set
        if (paymentInvoiceId == null) {
            throw new ApiException("Missing the required parameter 'paymentInvoiceId' when calling paymentSecupayInvoicesCancelById(Async)");
        }
        
        
        com.squareup.okhttp.Call call = paymentSecupayInvoicesCancelByIdCall(paymentInvoiceId, progressListener, progressRequestListener);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object paymentSecupayInvoicesCancelById(String paymentInvoiceId) throws ApiException {
        ApiResponse<Object> resp = paymentSecupayInvoicesCancelByIdWithHttpInfo(paymentInvoiceId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> paymentSecupayInvoicesCancelByIdWithHttpInfo(String paymentInvoiceId) throws ApiException {
        com.squareup.okhttp.Call call = paymentSecupayInvoicesCancelByIdValidateBeforeCall(paymentInvoiceId, null, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * POST Payment/Secupayinvoices/{paymentInvoiceId}/cancel (asynchronously)
     * DEPRECATED: use cancelPaymentTransactionById
     * @param paymentInvoiceId Payment invoice id (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call paymentSecupayInvoicesCancelByIdAsync(String paymentInvoiceId, final ApiCallback<Object> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = paymentSecupayInvoicesCancelByIdValidateBeforeCall(paymentInvoiceId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }

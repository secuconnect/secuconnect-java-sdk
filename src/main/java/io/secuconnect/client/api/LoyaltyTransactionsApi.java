...
import io.secuconnect.client.model.LoyaltyTransactionsList;
...
public class LoyaltyTransactionsApi {
     ...
     */
    public com.squareup.okhttp.Call getAllAsync(Integer count, Integer offset, String fields, String q, String sort, final ApiCallback<LoyaltyTransactionsList> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getOneCall(String loyaltyTransactionId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getOneValidateBeforeCall(String loyaltyTransactionId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getOneCall(loyaltyTransactionId, progressListener, progressRequestListener);
        return call;
    }
    ...
    public ApiResponse<LoyaltyTransactionsProductModel> getOneWithHttpInfo(String loyaltyTransactionId) throws ApiException {
        com.squareup.okhttp.Call call = getOneValidateBeforeCall(loyaltyTransactionId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getOneAsync(String loyaltyTransactionId, final ApiCallback<LoyaltyTransactionsProductModel> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getOneValidateBeforeCall(loyaltyTransactionId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<LoyaltyTransactionsProductModel>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }

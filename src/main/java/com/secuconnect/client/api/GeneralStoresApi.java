...
public class GeneralStoresApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Call assignGoogleKeyCall(String generalStoreId, String googleKey) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private Call assignGoogleKeyValidateBeforeCall(String generalStoreId, String googleKey) throws ApiException {
        ...
        return assignGoogleKeyCall(generalStoreId, googleKey);
    }
    ...
    public ApiResponse<ResultBoolean> assignGoogleKeyWithHttpInfo(String generalStoreId, String googleKey) throws ApiException {
        Call call = assignGoogleKeyValidateBeforeCall(generalStoreId, googleKey);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public Call assignGoogleKeyAsync(String generalStoreId, String googleKey, final ApiCallback<ResultBoolean> callback) throws ApiException {
        Call call = assignGoogleKeyValidateBeforeCall(generalStoreId, googleKey);
        Type localVarReturnType = new TypeToken<ResultBoolean>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;

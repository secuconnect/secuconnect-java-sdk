...
public class PaymentSecupayCreditcardsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Call paymentSecupayCreditcardsGetByIdCall(String paymentCreditCardsId) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private Call paymentSecupayCreditcardsGetByIdValidateBeforeCall(String paymentCreditCardsId) throws ApiException {
        ...
        return paymentSecupayCreditcardsGetByIdCall(paymentCreditCardsId);
    }

    /**
     * Read Payment Secupaycreditcard
     * Returns the specified Payment Secupaycreditcard.
     * @param paymentCreditCardsId Payment credit cards id (required)
     * @return SecupayTransactionProductModel
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    ...
    public ApiResponse<SecupayTransactionProductModel> paymentSecupayCreditcardsGetByIdWithHttpInfo(String paymentCreditCardsId) throws ApiException {
        Call call = paymentSecupayCreditcardsGetByIdValidateBeforeCall(paymentCreditCardsId);
        Type localVarReturnType = new TypeToken<SecupayTransactionProductModel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Read Payment Secupaycreditcard (asynchronously)
     * Returns the specified Payment Secupaycreditcard.
     * @param paymentCreditCardsId Payment credit cards id (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public Call paymentSecupayCreditcardsGetByIdAsync(String paymentCreditCardsId, final ApiCallback<SecupayTransactionProductModel> callback) throws ApiException {
        Call call = paymentSecupayCreditcardsGetByIdValidateBeforeCall(paymentCreditCardsId);
        Type localVarReturnType = new TypeToken<SecupayTransactionProductModel>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Call paymentSecupaycreditcardsPostCall(SecupayTransactionProductDTO body) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private Call paymentSecupaycreditcardsPostValidateBeforeCall(SecupayTransactionProductDTO body) throws ApiException {

        return paymentSecupaycreditcardsPostCall(body);
    }

    /**
     * Create Payment Secupaycreditcard
     * Creates a new Payment Secupaycreditcard from the given data. It can be used to start a credit card transaction.
     * @param body Credit card payment transaction input properties
     * @return SecupayTransactionProductModel
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    ...
    public ApiResponse<SecupayTransactionProductModel> paymentSecupaycreditcardsPostWithHttpInfo(SecupayTransactionProductDTO body) throws ApiException {
        Call call = paymentSecupaycreditcardsPostValidateBeforeCall(body);
        Type localVarReturnType = new TypeToken<SecupayTransactionProductModel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create Payment Secupaycreditcard (asynchronously)
     * Creates a new Payment Secupaycreditcard from the given data. It can be used to start a credit card transaction.
     * @param body Credit card payment transaction input properties
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public Call paymentSecupaycreditcardsPostAsync(SecupayTransactionProductDTO body, final ApiCallback<SecupayTransactionProductModel> callback) throws ApiException {
        Call call = paymentSecupaycreditcardsPostValidateBeforeCall(body);
        Type localVarReturnType = new TypeToken<SecupayTransactionProductModel>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;

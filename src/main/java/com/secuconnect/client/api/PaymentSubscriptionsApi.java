...
public class PaymentSubscriptionsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Call paymentSubscriptionsGetCall(Integer count, Integer offset, String fields, String q, String sort, String expand) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private Call paymentSubscriptionsGetValidateBeforeCall(Integer count, Integer offset, String fields, String q, String sort, String expand) throws ApiException {

        return paymentSubscriptionsGetCall(count, offset, fields, q, sort, expand);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PaymentSubscriptionsList paymentSubscriptionsGet(Integer count, Integer offset, String fields, String q, String sort, String expand) throws ApiException {
        ApiResponse<PaymentSubscriptionsList> resp = paymentSubscriptionsGetWithHttpInfo(count, offset, fields, q, sort, expand);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PaymentSubscriptionsList> paymentSubscriptionsGetWithHttpInfo(Integer count, Integer offset, String fields, String q, String sort, String expand) throws ApiException {
        Call call = paymentSubscriptionsGetValidateBeforeCall(count, offset, fields, q, sort, expand);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public Call paymentSubscriptionsGetAsync(Integer count, Integer offset, String fields, String q, String sort, String expand, final ApiCallback<PaymentSubscriptionsList> callback) throws ApiException {
        Call call = paymentSubscriptionsGetValidateBeforeCall(count, offset, fields, q, sort, expand);
        Type localVarReturnType = new TypeToken<PaymentSubscriptionsList>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;

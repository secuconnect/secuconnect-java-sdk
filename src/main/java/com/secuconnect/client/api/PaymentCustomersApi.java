...
public class PaymentCustomersApi {
     ...
     */
    public Call paymentCustomersGetCall(Integer count, Integer offset, String fields, String q, String sort, String expand) throws ApiException {
    ...
    private Call paymentCustomersGetValidateBeforeCall(Integer count, Integer offset, String fields, String q, String sort, String expand) throws ApiException {

        return paymentCustomersGetCall(count, offset, fields, q, sort, expand);
    }
     ...
     */
    public PaymentCustomersList paymentCustomersGet(Integer count, Integer offset, String fields, String q, String sort, String expand) throws ApiException {
        ApiResponse<PaymentCustomersList> resp = paymentCustomersGetWithHttpInfo(count, offset, fields, q, sort, expand);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PaymentCustomersList> paymentCustomersGetWithHttpInfo(Integer count, Integer offset, String fields, String q, String sort, String expand) throws ApiException {
        Call call = paymentCustomersGetValidateBeforeCall(count, offset, fields, q, sort, expand);
     ...
     */
    public Call paymentCustomersGetAsync(Integer count, Integer offset, String fields, String q, String sort, String expand, final ApiCallback<PaymentCustomersList> callback) throws ApiException {
        Call call = paymentCustomersGetValidateBeforeCall(count, offset, fields, q, sort, expand);
        Type localVarReturnType = new TypeToken<PaymentCustomersList>(){}.getType();

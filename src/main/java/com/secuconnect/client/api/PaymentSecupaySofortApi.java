...
public class PaymentSecupaySofortApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Call paymentSecupaySofortGetByIdCall(String paymentPrepayId) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private Call paymentSecupaySofortGetByIdValidateBeforeCall(String paymentPrepayId) throws ApiException {
        ...
        return paymentSecupaySofortGetByIdCall(paymentPrepayId);
    }

    /**
     * Read Payment Secupaysofort
    ...
    public ApiResponse<SecupayTransactionProductModel> paymentSecupaySofortGetByIdWithHttpInfo(String paymentPrepayId) throws ApiException {
        Call call = paymentSecupaySofortGetByIdValidateBeforeCall(paymentPrepayId);
        Type localVarReturnType = new TypeToken<SecupayTransactionProductModel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Read Payment Secupaysofort (asynchronously)
     * Get the details of a payment transaction
     * @param paymentPrepayId Payment prepay id (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public Call paymentSecupaySofortGetByIdAsync(String paymentPrepayId, final ApiCallback<SecupayTransactionProductModel> callback) throws ApiException {
        Call call = paymentSecupaySofortGetByIdValidateBeforeCall(paymentPrepayId);
        Type localVarReturnType = new TypeToken<SecupayTransactionProductModel>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Call paymentSecupaysofortPostCall(SecupayTransactionProductDTO body) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private Call paymentSecupaysofortPostValidateBeforeCall(SecupayTransactionProductDTO body) throws ApiException {

        return paymentSecupaysofortPostCall(body);
    }

    /**
     * Create Payment Secupaysofort
     * Creates a new Payment Secupaysofort from the given data.
     * @param body Prepay payment transaction input properties
     * @return SecupayTransactionProductModel
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    ...
    public ApiResponse<SecupayTransactionProductModel> paymentSecupaysofortPostWithHttpInfo(SecupayTransactionProductDTO body) throws ApiException {
        Call call = paymentSecupaysofortPostValidateBeforeCall(body);
        Type localVarReturnType = new TypeToken<SecupayTransactionProductModel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create Payment Secupaysofort (asynchronously)
     * Creates a new Payment Secupaysofort from the given data.
     * @param body Prepay payment transaction input properties
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public Call paymentSecupaysofortPostAsync(SecupayTransactionProductDTO body, final ApiCallback<SecupayTransactionProductModel> callback) throws ApiException {
        Call call = paymentSecupaysofortPostValidateBeforeCall(body);
        Type localVarReturnType = new TypeToken<SecupayTransactionProductModel>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;

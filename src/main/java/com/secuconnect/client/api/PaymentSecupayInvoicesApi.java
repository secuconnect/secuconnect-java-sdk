...
public class PaymentSecupayInvoicesApi {
     ...
     * Returns the specified Payment Secupayinvoice.
     * @param paymentInvoiceId Payment transaction ID (required)
     * @return SecupayTransactionProductModel
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    ...
    /**
     * Read Payment Secupayinvoice (asynchronously)
     * Returns the specified Payment Secupayinvoice.
     * @param paymentInvoiceId Payment transaction ID (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * Creates a new Payment Secupayinvoices from the given data. It can be used to start a invoice payment transaction.
     * @param body Invoice payment transaction input properties
     * @return SecupayTransactionProductModel
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    ...
    /**
     * Create Payment Secupayinvoices (asynchronously)
     * Creates a new Payment Secupayinvoices from the given data. It can be used to start a invoice payment transaction.
     * @param body Invoice payment transaction input properties
     * @param callback The callback to be executed when the API call finishes
     * @return The request call

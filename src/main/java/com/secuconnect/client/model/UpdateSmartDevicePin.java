...
public class UpdateSmartDevicePin {
  ...
  protected STO_ID storeId = null;

  @SerializedName("merchant_id")
  protected MRC_ID merchantId = null;

  @SerializedName("pin")
  protected String pin = null;

  public UpdateSmartDevicePin storeId(STO_ID storeId) {
   ...
   * @return storeId
  **/
  public STO_ID getStoreId() {
    return storeId;
  }

  public void setStoreId(STO_ID storeId) {
    this.storeId = storeId;
  }

  public UpdateSmartDevicePin merchantId(MRC_ID merchantId) {
   ...
   * @return merchantId
  **/
  public MRC_ID getMerchantId() {
    return merchantId;
  }

  public void setMerchantId(MRC_ID merchantId) {
    this.merchantId = merchantId;
  }

...
public class GeneralMerchantsPublicDataCompany {
  ...
  **/
  ...
  public GeneralMerchantsPublicDataCompany address(List<GeoAddress> address) {
    this.address = address;
    return this;
  }

  public GeneralMerchantsPublicDataCompany addAddressItem(GeoAddress addressItem) {

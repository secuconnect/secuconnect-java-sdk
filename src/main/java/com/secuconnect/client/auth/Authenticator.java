...
import com.secuconnect.client.auth.credentials.AuthenticationCredentials;
import com.secuconnect.client.auth.credentials.OAuthDeviceCodeCredentials;
import com.secuconnect.client.auth.credentials.OAuthDeviceCredentials;
import com.secuconnect.client.auth.credentials.OAuthRefreshCredentials;
import com.secuconnect.client.auth.tokens.AccessToken;
import com.secuconnect.client.auth.tokens.OAuthApplicationUserToken;
import com.secuconnect.client.auth.tokens.OAuthClientToken;
import com.secuconnect.client.auth.tokens.OAuthDeviceCodeToken;
import com.secuconnect.client.auth.tokens.OAuthDeviceToken;
import com.secuconnect.client.auth.tokens.OAuthRefreshToken;
...
public class Authenticator {
    ...
    public AccessToken getTokenFromApi() throws ApiException {
        ...
        String commonPath = "com.secuconnect.client.auth.credentials.";

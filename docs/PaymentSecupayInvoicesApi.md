...
try {
    ...
    System.err.println("Exception when calling PaymentSecupayInvoicesApi#cancelPaymentTransactionById");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling PaymentSecupayInvoicesApi#capturePaymentTransactionById");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling PaymentSecupayInvoicesApi#reverseAccrualByPaymentId");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling PaymentSecupayInvoicesApi#setShippingInformationByPaymentId");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling PaymentSecupayInvoicesApi#updateBasketByPaymentId");
    e.printStackTrace();
}
```
